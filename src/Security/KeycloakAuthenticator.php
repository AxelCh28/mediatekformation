...
class KeycloakAuthenticator extends OAuth2Authenticator implements AuthenticationEntryPointInterface {
    ...
    public function authenticate(Request $request): Passport {
        ...
        return new SelfValidatingPassport(
                new UserBadge($accessToken->getToken(), function() use ($accessToken, $client) {
                    ...
                    // 1) L'utilisateur est enregistré dans la BDD et s'est déjà connecté à Keycloak
                    ...
                    // 2) L'utilisateur est enregistré dans la BDD mais il ne s'est jamais connecté à Keycloak
                    ...
                    // 3) L'utilisateur n'est  pas enregistré dans la BDD et ne s'est jamais connecté à Keycloak
                    $user = new User();
    ...
    /**
     * Redirection vers la page formations dans l'admin après authentification réussie
     * @param Request $request
